import type {
	CamelCase,
	CamelCaseOptions,
	DefaultCamelCaseOptions,
} from "./camel-case";
import type { ApplyDefaultOptions, NonRecursiveType } from "./internal/index";
			...
			: Value extends object
				? {
						[K in keyof Value as CamelCase<
							K,
							Options
						>]: _CamelCasedPropertiesDeep<Value[K], Options>;
					}
				: Value;
...
> = Value extends []
	...
	: // Trailing spread array
		...
		? [
				_CamelCasedPropertiesDeep<U, Options>,
				..._CamelCasedPropertiesDeep<V, Options>,
			]
