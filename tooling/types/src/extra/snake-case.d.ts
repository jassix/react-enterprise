...
*/
export type SnakeCase<Value, Options extends WordsOptions = {}> = DelimiterCase<
	Value,
	"_",
	ApplyDefaultOptions<WordsOptions, DefaultDelimiterCaseOptions, Options>
>;
