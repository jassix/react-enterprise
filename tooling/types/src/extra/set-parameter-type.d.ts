...
```
*/
type MergeObjectToArray<
	TArray extends UnknownArray,
	TObject,
	TArrayCopy extends UnknownArray = TArray,
> = TObject extends UnknownArray // If `TObject` is an array like `[0, 1, 2]`
...
> = Function_ extends ( // Just using `Parameters<Fn>` isn't ideal because it doesn't handle the `this` fake parameter.
