...
import { Avatar, Badge, Button, Card, Icon, Input, Separator } from "@lume/primitives";

const Section = ({ label, className }: { label: string; className: string }) => (
  <div
    className={className}
    style={{
    ...
    <Card size="md">
      <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          ...
          <span style={{ fontSize: 12, color: "var(--colors-foreground-tertiary)" }}>
            Admin · since 2024
          </span>
        </div>
      </div>
