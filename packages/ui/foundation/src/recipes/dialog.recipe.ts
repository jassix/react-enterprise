...
export const dialogRecipe = defineSlotRecipe({
	...
	base: {
		...
		closeTrigger: {
			...
			alignItems: "center",
			justifyContent: "center",
			width: "2rem", // 32 — luma `size-8` icon-sm
			height: "2rem",
	...
	variants: {
		size: {
			xs: { content: { width: "20rem" } }, // 320
			sm: { content: { width: "24rem" } }, // 384
			md: { content: { width: "28rem" } }, // 448 — luma `sm:max-w-md`
			lg: { content: { width: "32rem" } }, // 512
			xl: { content: { width: "48rem" } }, // 768
			full: {
				content: {
					width: "100%",
