...
export const toggleRecipe = defineSlotRecipe({
  ...
  base: {
    root: {
      ...
      transition:
        "background-color {durations.normal} {easings.easeOut}, color {durations.normal} {easings.easeOut}, border-color {durations.press} {easings.easeOut}, box-shadow {durations.press} {easings.easeOut}, transform {durations.press} {easings.easeOut}",
      ...
      "@media (prefers-reduced-motion: reduce)": {
        transition:
          "background-color {durations.fast} {easings.easeOut}, color {durations.fast} {easings.easeOut}, border-color {durations.press} {easings.easeOut}, box-shadow {durations.press} {easings.easeOut}",
    ...
    indicator: {
      ...
      transition:
        "width {durations.normal} {easings.easeOut}, margin-inline-start {durations.normal} {easings.easeOut}, opacity {durations.normal} {easings.easeOut}, transform {durations.normal} {easings.spring}",
      ...
      "@media (prefers-reduced-motion: reduce)": {
        transition:
          "width {durations.fast} {easings.easeOut}, margin-inline-start {durations.fast} {easings.easeOut}, opacity {durations.fast} {easings.easeOut}",
        transform: "none",
        ':where([data-state="on"], [data-pressed="true"], [aria-pressed="true"]) &': {
          transform: "none",
        },
