...
export const datePickerRecipe = defineSlotRecipe({
	...
	base: {
		...
		tableCell: {
			...
			"&[data-range-start='true']": { borderStartStartRadius: "var(--cell-radius)", borderEndStartRadius: "var(--cell-radius)" },
			"&[data-range-end='true']": { borderStartEndRadius: "var(--cell-radius)", borderEndEndRadius: "var(--cell-radius)" },
