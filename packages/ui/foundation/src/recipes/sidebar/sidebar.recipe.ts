...
export const sidebarRecipe = defineSlotRecipe({
  ...
  base: {
    ...
    container: {
      ...
      width: "var(--sidebar-width)",
      transition:
        "left {durations.normal} {easings.easeOut}, right {durations.normal} {easings.easeOut}, width {durations.normal} {easings.easeOut}",
    ...
    groupLabel: {
      ...
      outline: "none",
      transition:
        "margin {durations.normal} {easings.easeOut}, opacity {durations.normal} {easings.easeOut}",
