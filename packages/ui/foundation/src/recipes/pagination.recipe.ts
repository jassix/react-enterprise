...
export const paginationRecipe = defineSlotRecipe({
	...
	variants: {
		size: {
			sm: {
				item: { height: "2rem", minWidth: "2rem", paddingInline: "{spacing.md}", fontSize: "{fontSizes.xs}" },
			...
			lg: {
				...
				prevTrigger: { height: "2.5rem", paddingInline: "{spacing.lg}", fontSize: "{fontSizes.md}" },
				nextTrigger: { height: "2.5rem", paddingInline: "{spacing.lg}", fontSize: "{fontSizes.md}" },
