...
export const sliderRecipe = defineSlotRecipe({
  ...
  base: {
    ...
    thumb: {
      ...
      bg: "white",
      boxShadow:
        "0 1px 2px rgb(0 0 0 / 0.1), 0 2px 4px -2px rgb(0 0 0 / 0.1), 0 0 0 1px rgb(0 0 0 / 0.1)",
      cursor: "grab",
      outline: "none",
      userSelect: "none",
  ...
  compoundVariants: [
    {
      intent: "critical",
      css: {
        range: { bg: "{colors.critical.accent}" },
        thumb: { borderColor: "{colors.critical.accent}" },
      },
    },
    {
      intent: "positive",
      css: {
        range: { bg: "{colors.positive.accent}" },
        thumb: { borderColor: "{colors.positive.accent}" },
      },
    },
    {
      intent: "caution",
      css: {
        range: { bg: "{colors.caution.accent}" },
        thumb: { borderColor: "{colors.caution.accent}" },
      },
    },
    {
      intent: "info",
      css: {
        range: { bg: "{colors.info.accent}" },
        thumb: { borderColor: "{colors.info.accent}" },
      },
    },
  ],
});
