const tokens = {
  ...
  "colors.accent.dark.11": {
    "value": "hsl(252, 75%, 80%)",
    "variable": "var(--colors-accent-dark-11)"
  },
  "colors.accent.dark.12": {
    "value": "hsl(252, 87%, 96%)",
    "variable": "var(--colors-accent-dark-12)"
  },
  "colors.accent.light.1": {
    "value": "hsl(252, 100%, 99%)",
    "variable": "var(--colors-accent-light-1)"
  },
  "colors.accent.light.2": {
    "value": "hsl(252, 100%, 98%)",
  ...
  "colors.accent.light.11": {
    "value": "hsl(252, 60%, 45%)",
    "variable": "var(--colors-accent-light-11)"
  },
  "colors.accent.light.12": {
    "value": "hsl(252, 60%, 25%)",
    "variable": "var(--colors-accent-light-12)"
  },
  ...
  "colors.red.light.1": {
    "value": "hsl(359, 100%, 99%)",
    "variable": "var(--colors-red-light-1)"
  },
  "colors.red.light.2": {
    "value": "hsl(359, 100%, 98%)",
  ...
  "colors.pink.light.1": {
    "value": "hsl(322, 100%, 99%)",
    "variable": "var(--colors-pink-light-1)"
  },
  "colors.pink.light.2": {
    "value": "hsl(323, 100%, 98%)",
  ...
  "colors.cyan.dark.5": {
    "value": "hsl(186, 100%, 11%)",
    "variable": "var(--colors-cyan-dark-5)"
  },
  "colors.cyan.dark.6": {
    "value": "hsl(184, 100%, 13%)",
  ...
  "fonts.mono": {
    "value": "'Fira Code', 'JetBrains Mono', 'Cascadia Code', Consolas, 'Courier New', monospace",
  ...
  "lineHeight.compact": {
    "value": 1.1,
    "variable": "var(--line-height-compact)"
  },
  "lineHeight.tight": {
    "value": 1.25,
    "variable": "var(--line-height-tight)"
  },
  "lineHeight.normal": {
    "value": 1.4,
    "variable": "var(--line-height-normal)"
  },
  "lineHeight.relaxed": {
    "value": 1.6,
    "variable": "var(--line-height-relaxed)"
  },
  "lineHeight.loose": {
    "value": 1.75,
    "variable": "var(--line-height-loose)"
  },
  "containers.xs": {
    "value": "320px",
    "variable": "var(--containers-xs)"
  },
  "containers.sm": {
    "value": "640px",
    "variable": "var(--containers-sm)"
  },
  "containers.md": {
    "value": "768px",
    "variable": "var(--containers-md)"
  },
  "containers.lg": {
    "value": "1024px",
    "variable": "var(--containers-lg)"
  },
  "containers.xl": {
    "value": "1280px",
    "variable": "var(--containers-xl)"
  },
  "containers.2xl": {
    "value": "1536px",
    "variable": "var(--containers-2xl)"
  },
  "containers.full": {
    "value": "100%",
    "variable": "var(--containers-full)"
  },
  "zIndex.base": {
    "value": "0",
  ...
  "blur.none": {
    "value": "0",
    "variable": "var(--blur-none)"
  },
  "blur.xs": {
    "value": "2px",
    "variable": "var(--blur-xs)"
  },
  "blur.sm": {
    "value": "4px",
    "variable": "var(--blur-sm)"
  },
  "blur.md": {
    "value": "8px",
    "variable": "var(--blur-md)"
  },
  "blur.lg": {
    "value": "16px",
    "variable": "var(--blur-lg)"
  },
  "blur.xl": {
    "value": "24px",
    "variable": "var(--blur-xl)"
  },
  "blur.2xl": {
    "value": "40px",
    "variable": "var(--blur-2xl)"
  },
  "blur.3xl": {
    "value": "64px",
    "variable": "var(--blur-3xl)"
  },
  "durations.instant": {
    "value": "75ms",
  ...
  "colors.colorPalette.critical": {
    "value": "var(--colors-color-palette-critical)",
    "variable": "var(--colors-color-palette-critical)"
  },
  "colors.colorPalette.positive": {
    "value": "var(--colors-color-palette-positive)",
    "variable": "var(--colors-color-palette-positive)"
  },
  "colors.colorPalette.caution": {
    "value": "var(--colors-color-palette-caution)",
    "variable": "var(--colors-color-palette-caution)"
  },
  ...
  "colors.colorPalette.sm": {
    "value": "var(--colors-color-palette-sm)",
    "variable": "var(--colors-color-palette-sm)"
  },
  "colors.colorPalette.md": {
    "value": "var(--colors-color-palette-md)",
    "variable": "var(--colors-color-palette-md)"
  },
  "colors.colorPalette.lg": {
    "value": "var(--colors-color-palette-lg)",
    "variable": "var(--colors-color-palette-lg)"
  },
  "colors.colorPalette.xl": {
    "value": "var(--colors-color-palette-xl)",
    "variable": "var(--colors-color-palette-xl)"
  },
  "colors.colorPalette.2xl": {
    "value": "var(--colors-color-palette-2xl)",
    "variable": "var(--colors-color-palette-2xl)"
  },
  "colors.colorPalette.inner": {
    "value": "var(--colors-color-palette-inner)",
    "variable": "var(--colors-color-palette-inner)"
  },
  "colors.colorPalette.ring": {
    "value": "var(--colors-color-palette-ring)",
    "variable": "var(--colors-color-palette-ring)"
  },
  "colors.colorPalette.ringOffset": {
    "value": "var(--colors-color-palette-ring-offset)",
    "variable": "var(--colors-color-palette-ring-offset)"
  },
  "colors.colorPalette.ringWidth": {
    "value": "var(--colors-color-palette-ring-width)",
    "variable": "var(--colors-color-palette-ring-width)"
  },
  "colors.colorPalette.ringOffsetWidth": {
    "value": "var(--colors-color-palette-ring-offset-width)",
    "variable": "var(--colors-color-palette-ring-offset-width)"
  },
  "colors.colorPalette.skipLink": {
