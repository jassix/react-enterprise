...
type CarouselSlot = "root" | "viewport" | "itemGroup" | "item" | "prevTrigger" | "nextTrigger" | "indicatorGroup" | "indicator" | "root" | "viewport" | "itemGroup" | "item" | "prevTrigger" | "nextTrigger" | "indicatorGroup" | "indicator"
...
/**
 * Luma carousel — embla viewport with outside prev / next triggers
 */
