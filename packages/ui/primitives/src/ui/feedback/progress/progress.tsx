...
export interface ProgressRootProps
  extends
    Omit<HTMLStyledProps<"div">, keyof ProgressPrimitive.RootBaseProps>,
...
export interface ProgressLabelProps
  extends
    Omit<HTMLStyledProps<"label">, keyof ProgressPrimitive.LabelBaseProps>,
...
export interface ProgressTrackProps
  extends
    Omit<HTMLStyledProps<"div">, keyof ProgressPrimitive.TrackBaseProps>,
...
export interface ProgressRangeProps
  extends
    Omit<HTMLStyledProps<"div">, keyof ProgressPrimitive.RangeBaseProps>,
...
export interface ProgressValueTextProps
  extends
    Omit<HTMLStyledProps<"span">, keyof ProgressPrimitive.ValueTextBaseProps>,
...
const ValueText: FC<ProgressValueTextProps> = ({ size, intent, variant, ...props }) => {
  ...
  return (
    <ProgressPrimitive.ValueText
      ...
      {...restProps}
      className={cx(progress({ size, intent, variant }).valueText, css(cssProps), props.className)}
    />
  );
};
