...
const Title: FC<AlertTitleProps> = ({ className, ...props }) => (
  <div data-slot="alert-title" {...props} className={cx(alert().title, className)} />
);
...
const Description: FC<AlertDescriptionProps> = ({ className, ...props }) => (
  <div data-slot="alert-description" {...props} className={cx(alert().description, className)} />
);
...
const Action: FC<AlertActionProps> = ({ className, ...props }) => (
  <div data-slot="alert-action" {...props} className={cx(alert().action, className)} />
);
