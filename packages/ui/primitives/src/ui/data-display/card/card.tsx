...
const Root: FC<CardProps> = ({ size, interactive, ref, ...props }) => {
  ...
  return (
    <ark.div
      ...
      data-size={size ?? "md"}
      {...restProps}
      className={cx(card({ size, interactive }).root, css(cssProps), props.className)}
    />
  );
};
...
const Header: FC<CardHeaderProps> = ({ size, className, ...props }) => (
  <div data-slot="card-header" {...props} className={cx(card({ size }).header, className)} />
);
...
const Title: FC<CardTitleProps> = ({ size, className, ...props }) => (
  <div data-slot="card-title" {...props} className={cx(card({ size }).title, className)} />
);
...
const Action: FC<CardActionProps> = ({ size, className, ...props }) => (
  <div data-slot="card-action" {...props} className={cx(card({ size }).action, className)} />
);
...
const Content: FC<CardContentProps> = ({ size, className, ...props }) => (
  <div data-slot="card-content" {...props} className={cx(card({ size }).content, className)} />
);
...
const Footer: FC<CardFooterProps> = ({ size, className, ...props }) => (
  <div data-slot="card-footer" {...props} className={cx(card({ size }).footer, className)} />
);
