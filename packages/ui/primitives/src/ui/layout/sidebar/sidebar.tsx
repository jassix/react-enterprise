...
function useIsMobile(breakpoint = 768): boolean {
  ...
  useEffect(() => {
    ...
    const media = globalThis.matchMedia(`(max-width: ${breakpoint - 1}px)`);
...
export interface SidebarMenuProps
  extends Omit<HTMLStyledProps<"ul">, keyof ComponentProps<"ul">>, ComponentProps<"ul"> {}
...
export interface SidebarInsetProps
  extends Omit<HTMLStyledProps<"main">, keyof ComponentProps<"main">>, ComponentProps<"main"> {}
export interface SidebarInputProps
  extends Omit<HTMLStyledProps<"input">, keyof ComponentProps<"input">>, ComponentProps<"input"> {}
...
const MenuBadge: FC<SidebarMenuBadgeProps> = slotWrapper("div", "menuBadge", "sidebar-menu-badge");
...
const Separator: FC<SidebarSeparatorProps> = slotWrapper("div", "separator", "sidebar-separator");
